...
# Bot information
SESSION = environ.get('SESSION', 'BeastBOT')
API_ID = int(environ.get('API_ID', '29599760'))
API_HASH = environ.get('API_HASH', '71b53f9d8fc9639f2f263441567db1f6')
BOT_TOKEN = environ.get('BOT_TOKEN', "8170854413:AAHMcNAsCbHWxZ8ZkMfavJU4UJrxsKj77A0")


# This Pictures Is For Start Message Picture, You Can Add Multiple By Giving One Space Between Each.
PICS = (environ.get('PICS', 'https://i.ibb.co/C50c9q1s/photo-2025-05-06-04-27-54-7501184911022227480.jpg')).split()


# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6265745413').split()] # For Multiple Id Use One Space Between Each.
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002623311440'))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002664736857').split()]  # For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002491575968') # give your force subscribe channel id here else leave it blank
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://BeastDB:<BeastDB2010>@cluster0.lhz7ral.mongodb.net/filterDB?retryWrites=true&w=majority&tls=true&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
DATABASE_NAME = environ.get('DATABASE_NAME', "BeastDB")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'BeastCollection')
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+zujzK-S7i5RkM2Y1')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/+xFfcl1XIxMYyOTg1')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'Beast_disscussion') # Support Chat Link Without https:// or @
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/Royal_Beast_X')
